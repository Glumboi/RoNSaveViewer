...
namespace RoNSaveViewer_WPF.ViewModels
{
    ...
    {
        private Visibility _fileOpenVisibility = Visibility.Collapsed;

        public Visibility FileOpenVisibility
        {
            get => _fileOpenVisibility;
            set => SetProperty(ref _fileOpenVisibility, value);
        }
        ...
        public Visibility SplashVisibility
        {
            ...
            set => SetProperty(ref _splashVisibility, value);
        }
        ...
        public string FilePath
        {
            ...
            set
            {
                ...
                FileOpenVisibility = Visibility.Visible;
        ...
        private void AddStructPropertyToEditField(UProperty prop)
        {
            ...
            bool hadPropertiesProp = false;

            foreach (var item in props)
            {
                if (item.Name == "Properties")
                {
                    hadPropertiesProp = true;
            ...
            if (!hadPropertiesProp)
            {
                EditableRoNSaveObjects.Add(new EditableRoNSaveObject(prop));
            }
        }
