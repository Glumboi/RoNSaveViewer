...
namespace RoNSaveViewer_WPF.ViewModels
{
    internal class MainWindowViewModel : ViewModelBase
    {
        ...
        public UProperty _selectedRoNObject;

        public UProperty SelectedRoNObject
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    {
                        case "StructProperty":
                            AddStructPropertyToEditField(value);
                            break;

                        //Partial implementation
                        case "MapProperty":
                            object originalObject = value.Value;
