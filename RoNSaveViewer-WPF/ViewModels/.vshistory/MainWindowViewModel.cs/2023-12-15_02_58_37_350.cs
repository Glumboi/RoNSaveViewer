                ...
                if (value != null)
                {
                    switch (value.OBJUProperty.Type)
                    {
                        case "StructProperty":
                            ...
                            break;
                        case "MapProperty":
                            KeyValuePair<ObjectProperty, ObjectProperty> val2 = value.OBJUProperty.Value as KeyValuePair<ObjectProperty, ObjectProperty>;
                           
                            foreach (var item in val2.Value)
                            {
                                EditableRoNSaveObjects.Add(new EditableRoNSaveObject(item));
                            }
                            break;
                        default:
                            EditableRoNSaveObjects.Add(new EditableRoNSaveObject(value.OBJUProperty));
