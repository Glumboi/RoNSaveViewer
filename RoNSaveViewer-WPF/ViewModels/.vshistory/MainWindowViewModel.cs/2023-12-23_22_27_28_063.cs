    ...
    internal class MainWindowViewModel : ViewModelBase
    {
        ...
        private void IdentifyProp(UProperty uProp)
        {
            switch (uProp.Type)
            {
                ...
                case "ObjectProperty":
                    SaveObjectProperties.Add(uProp.Value as ObjectProperty);
                    break;
        ...
        private void IdentifyProp(RoNSaveObject roNSaveObject)
        {
            switch (roNSaveObject.OBJUProperty.Type)
            {
                ...
                case "ObjectProperty":
                    SaveObjectProperties.Add(roNSaveObject.OBJUProperty as ObjectProperty);
                    break;
        ...
        private void AddStructPropertyToEditField(StructProperty prop)
        {
            IEnumerable objects = prop.Value as IEnumerable;
            foreach (var item in objects)
            {
                IdentifyProp(item as UProperty);
            }
