...
namespace RoNSaveViewer_WPF.ViewModels
{
    internal class MainWindowViewModel : ViewModelBase
    {
        ...
        private void IdentifyProp(UProperty obj)
        {
            switch (obj.Type)
            {
                case "StructProperty":
                    AddStructPropertyToEditField(obj);
                    break;

                //Partial implementation
                case "MapProperty":
                    AddMapProperty(obj.Value);
                    break;

                case "ObjectProperty":
                    AddObjectProperty(obj as ObjectProperty);
                    break;

                default:
                    SaveObjects.Add(obj.OBJUProperty);
                    break;
            }
        }
