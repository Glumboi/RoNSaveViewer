...
namespace RoNSaveViewer_WPF.ViewModels
{
    internal class MainWindowViewModel : ViewModelBase
    {
        ...
        public ObservableCollection<ArrayProperty> _saveArrayProperties = new();

        public ObservableCollection<ObjectProperty> SaveArrayProperties
        {
            get => _saveArrayProperties;
            set => SetProperty(ref _saveArrayProperties, value);
        }
