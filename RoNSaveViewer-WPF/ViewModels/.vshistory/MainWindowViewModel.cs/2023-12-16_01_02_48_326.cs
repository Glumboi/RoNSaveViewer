    ...
    internal class MainWindowViewModel : ViewModelBase
    {
        ...
        public string FilePath
        {
            ...
            set
            {
                ...
                {
                    RoNSaveGame = new RoNSave(SaveGame.LoadFrom(fs));
                }
            }
        }
        ...
        public RoNSave _roNSaveGame;

        public RoNSave RoNSaveGame
        {
            get => _roNSaveGame;
            set
            {
                ...
                foreach (UProperty prop in _roNSaveGame.GameSave.Properties)
                {
